...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (Apartment el: apartments
            ...
            if (el instanceof Apt1Room) {
                ((Apt1Room) el).clean1Room();
            } else if (el instanceof Apt2Room) {
                ((Apt2Room) el).clean2Rooms();
            } else if (el instanceof Apt3Room) {
                ((Apt3Room) el).clean3Rooms();
            }
        }
