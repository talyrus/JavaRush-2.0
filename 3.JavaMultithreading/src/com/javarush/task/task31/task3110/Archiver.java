...
public class Archiver {
    public static void main(String[] args) throws IOException {
        ...
        do {
            try {
                operation = askOperation(); // запросим выбор действий
                CommandExecutor.execute(operation); // выполним требуемое действие
        ...
        } while (operation != Operation.EXIT); // пока в консоли не выбран пункт EXIT
    }
